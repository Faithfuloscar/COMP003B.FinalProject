...
namespace COMP003B.FinalProject.Controllers
{
    public class SessionsController : Controller
    {
        ...
        public SessionsController(FitContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("SessionId,UserId,Date,Duration")] Session session)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SessionId,UserId,Date,Duration")] Session session)
        {
